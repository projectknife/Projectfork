 ...
 *
 */
class ProjectforkControllerTimeform extends JControllerForm
{
    /**
     ...
     */
    public function &getModel($name = 'TimeForm', $prefix = '', $config = array('ignore_request' => true))
    {
    ...
    protected function allowEdit($data = array(), $key = 'id')
    {
        ...
        $access = ProjectforkHelperAccess::getActions('time', $id);
