 ...
 *
 */
class ProjectforkControllerNoteform extends JControllerForm
{
    /**
     ...
     */
    public function &getModel($name = 'NoteForm', $prefix = 'ProjectforkModel', $config = array('ignore_request' => true))
    {
    ...
    protected function allowEdit($data = array(), $key = 'id')
    {
        ...
        $access = ProjectforkHelperAccess::getActions('note', $id);
