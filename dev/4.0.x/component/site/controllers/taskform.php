 ...
 *
 */
class ProjectforkControllerTaskform extends JControllerForm
{
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		$userId		= $user->get('id');
		$asset		= 'com_projectfork.task.'.$recordId;
		...
		if ($user->authorise('core.edit.own', $asset) || $user->authorise('task.edit.own', $asset)) {
	 ...
	 */
	public function &getModel($name = 'TaskForm', $prefix = '', $config = array('ignore_request' => true))
	{
	...
	function setProject()
	{
		...
		$app->setUserState('com_projectfork.edit.taskform.id', $recordId);
