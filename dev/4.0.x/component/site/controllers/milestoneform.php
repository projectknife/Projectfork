 ...
 *
 */
class ProjectforkControllerMilestoneform extends JControllerForm
{
    /**
     ...
     * @var    string
     */
    protected $view_item = 'milestoneform';
     ...
     */
    public function &getModel($name = 'MilestoneForm', $prefix = '', $config = array('ignore_request' => true))
    {
    ...
    public function setProject()
    {
        ...
        $app->setUserState('com_projectfork.edit.milestoneform.id', $id);
    ...
    protected function allowEdit($data = array(), $key = 'id')
    {
        ...
        $access = ProjectforkHelperAccess::getActions('milestone', $id);
        ...
        if ($access->get('milestone.edit.own')) {
