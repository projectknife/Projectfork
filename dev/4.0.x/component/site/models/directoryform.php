...
require_once JPATH_ADMINISTRATOR.'/components/com_projectfork/models/directory.php';
 ...
 *
 */
class ProjectforkModelDirectoryForm extends ProjectforkModelDirectory
{
    /**
     * Constructor.
     *
    ...
    public function getItem($id = null)
    {
        ...
        $access = ProjectforkHelperAccess::getActions('directory', $value->id);

        // Check general edit permission first.
        if ($access->get('directory.edit')) {
            $value->params->set('access-edit', true);
        }
        elseif (!empty($uid) && $access->get('directory.edit.own')) {
        ...
        if ($id) {
            // Existing item
            $value->params->set('access-change', $access->get('directory.edit.state'));
        }
        else {
            // New item
