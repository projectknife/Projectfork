...
require_once JPATH_ADMINISTRATOR.'/components/com_projectfork/models/note.php';
 ...
 *
 */
class ProjectforkModelNoteForm extends ProjectforkModelNote
{
    /**
     * Constructor.
     *
    ...
    public function getItem($id = null)
    {
        ...
        $access = ProjectforkHelperAccess::getActions('note', $value->id);

        // Check general edit permission first.
        if ($access->get('note.edit')) {
            $value->params->set('access-edit', true);
        }
        elseif (!empty($uid) && $access->get('note.edit.own')) {
        ...
        if ($id) {
            // Existing item
            $value->params->set('access-change', $access->get('note.edit.state'));
        }
        else {
            // New item
