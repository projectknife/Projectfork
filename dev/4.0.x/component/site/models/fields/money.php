...
class JFormFieldMoney extends JFormField
{
    ...
    protected function getInput()
    {
        ...
        $html[] = '<input type="text" name="' . $this->name . '_v1" id="' . $this->id . '_v1" size="10" class="inputbox input-small" maxlength="' . $maxlength . '" value="' . $v1 . '" ' . $onchange . $disabled . $readonly . '/>';
        $html[] = '<span>&nbsp;<strong>' . $decimal . '</strong>&nbsp;</span>';
        $html[] = '<input type="text" name="' . $this->name . '_v2" id="' . $this->id . '_v2" size="10" class="inputbox input-mini" maxlength="2" value="' . $v2 . '" ' . $onchange . $disabled . $readonly . '/>';
