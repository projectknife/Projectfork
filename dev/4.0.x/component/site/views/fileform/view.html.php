...
/**
 * File Form View Class for Projectfork component
 *
 */
class ProjectforkViewFileForm extends JViewLegacy
{
    protected $form;
    protected $item;
    ...
    public function display($tpl = null)
    {
        ...
        if (empty($this->item->id)) {
            ...
            $authorised = $access->get('file.create');
        }
        else {
    ...
    protected function _prepareDocument()
    {
        ...
        if ($menu) {
            ...
            $this->params->def('page_heading', JText::_('COM_PROJECTFORK_FORM_EDIT_FILE'));
        }

        $title = $this->params->def('page_title', JText::_('COM_PROJECTFORK_FORM_EDIT_FILE'));
