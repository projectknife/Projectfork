...
<form action="<?php echo htmlspecialchars(JFactory::getURI()->toString()); ?>" method="post" name="adminForm" id="item-form" class="form-validate form-inline">
    <fieldset>
        <div class="formelm-buttons btn-toolbar">
            <button class="btn btn-primary" type="button" onclick="Joomla.submitbutton('directoryform.save')">
                <?php echo JText::_('JSAVE') ?>
            </button>
            <button class="btn" type="button" onclick="Joomla.submitbutton('directoryform.cancel')">
    ...
    <?php echo JHtml::_('tabs.panel', 'Permissions', 'directory-permissions') ;?>
    <fieldset>
        <div class="formelm control-group">
    		<div class="control-label">
    ...
    <?php echo JHtml::_('tabs.panel', 'Options', 'directory-options') ;?>
