            ...
            <div class="<?php echo $filter_in;?>collapse" id="filters">
                <div class="well btn-toolbar">
                    ...
                    <?php if ($this->state->get('filter.project')) : ?>
                        <div class="filter-milestone btn-group pull-right">
                        ...
                        <div class="filter-tasklist btn-group pull-right">
                        ...
                        <div class="filter-user btn-group pull-right">
                    ...
                    <?php if ($this->access->get('task.edit.state') || $this->access->authorise('task.edit')) : ?>
                        <div class="filter-status btn-group pull-right">
                    ...
                    <?php endif; ?>
                    <div class="filter-priority btn-group pull-right">
