...
class ProjectforkViewDirectory extends JViewLegacy
{
    protected $form;
    protected $item;
    protected $state;
    ...
    protected function addToolbar()
    {
        ...
        $access      = ProjectforkHelperAccess::getActions('directory', $this->item->id);
        ...
        if ($is_new) {
            ...
            if (!$checked_out) {
                if ($access->get('directory.edit') || ($access->get('directory.edit.own') && $this->item->created_by == $uid)) {
                    JToolBarHelper::apply('directory.apply');
                    JToolBarHelper::save('directory.save');
                    JToolBarHelper::save2new('directory.save2new');
                }
