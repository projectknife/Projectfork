...
<form action="<?php echo JRoute::_('index.php?option=com_projectfork&view=projectform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
