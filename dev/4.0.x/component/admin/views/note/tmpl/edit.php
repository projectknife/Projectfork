...
<form action="<?php echo JRoute::_('index.php?option=com_projectfork&view=note&id='.(int) $this->item->id . '&layout=edit'); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
