...
$access      = ProjectforkHelperAccess::getActions('directory', $this_dir->id);
?>
<form action="<?php echo JRoute::_('index.php?option=com_projectfork&view=repository' . $link_append); ?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
