...
class ProjectforkViewTimesheet extends JViewLegacy
{
    /**
     * A list of topics
     *
    ...
    protected function addToolbar()
    {
        ...
        if ($access->get('time.edit') || $access->get('time.edit.own')) {
        ...
        if ($this->state->get('filter.published') == -2 && $access->get('time.delete')) {
