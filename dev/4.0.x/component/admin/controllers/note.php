...
class ProjectforkControllerNote extends JControllerForm
{
    /**
    ...
    protected function allowAdd($data = array())
    {
        ...
        if ($dir_id) {
            ...
            $access = ProjectforkHelperAccess::getActions('note');

            if (!$access->get('create.note')) {
