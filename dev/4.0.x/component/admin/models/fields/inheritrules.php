 ...
 *
 */
class JFormFieldInheritRules extends JFormField
{
    /**
     * The form field type.
     *
    ...
    protected function getInput()
    {
        ...
        $this->create_access = (int) $this->form->getValue('access_action');
    ...
    protected function getUserGroups()
    {
        ...
        // We're not trying to create a new access level
        if (!$this->create_access) {
            ...
            // We're trying to create a new access level.
            if (!$this->is_admin) {
