...
JLoader::register('PFtasksModelTasklist', JPATH_ADMINISTRATOR . '/components/com_pftasks/models/tasklist.php');
 ...
 *
 */
class PFtasksModelTasklistForm extends PFtasksModelTasklist
{
    /**
