...
<fieldset id="filter-bar">
    ...
    <div class="filter-select fltrt">
        <?php if ($this->state->get('filter.project')) : ?>
            ...
            <div class="fltrt">
                <select name="filter_task" class="inputbox input-medium" onchange="this.form.submit()">
                    <option value=""><?php echo JText::_('COM_PROJECTFORK_OPTION_SELECT_TASK');?></option>
                    <?php echo JHtml::_('select.options', $this->tasks, 'value', 'text', $this->state->get('filter.task'));?>
                </select>
            </div>
        <?php endif; ?>
        <div class="fltrt">
