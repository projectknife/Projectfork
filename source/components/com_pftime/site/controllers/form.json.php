...
JLoader::register('PFtimeControllerTime', JPATH_ADMINISTRATOR . '/components/com_pftime/controllers/time.json.php');
 ...
 *
 */
class PFtimeControllerForm extends PFtimeControllerTime
{
    /**
