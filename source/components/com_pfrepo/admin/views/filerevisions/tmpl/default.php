...
<form action="<?php echo JRoute::_('index.php?option=com_pfrepo&view=filerevisions'); ?>" method="post" name="adminForm" id="adminForm">
    <?php
    if (!$this->is_j25) :
    ...
    <table class="adminlist table table-striped">
        ...
        <tbody>
            <?php foreach ($this->items as $i => $item) :
                ...
                $dl_link = 'index.php?option=com_pfrepo&task=file.download'
