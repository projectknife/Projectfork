 ...
 *
 */
class PFrepoModelNoteRevisions extends JModelList
{
    /**
     * Constructor
     *
    ...
    public function getItem($pk = 0)
    {
        ...
        $model = $this->getInstance('Note', 'PFrepoModel', $cfg);
    ...
    public function getAuthors()
    {
        ...
        $query->select('u.id AS value, u.name AS text')
              ->from('#__users AS u')
              ->join('INNER', '#__pf_repo_note_revs AS a ON a.created_by = u.id')
    ...
    protected function getListQuery()
    {
        ...
        $query->from('#__pf_repo_note_revs AS a');
