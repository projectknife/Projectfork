...
JLoader::register('PFforumHelperRoute', JPATH_SITE . '/components/com_pfforum/helpers/route.php');
...
abstract class PFforumNotificationsHelper
{
    ...
    public static function getObservers($context, $table, $is_new = false)
    {
        ...
        if ($opt_out) {
            ...
            $forum_groups = PFAccessHelper::getGroupsByAccessLevel($table->access);
