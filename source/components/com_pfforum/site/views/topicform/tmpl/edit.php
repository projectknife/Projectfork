...
<form action="<?php echo JRoute::_('index.php?option=com_pfforum&view=topicform&id=' . (int) $this->item->id . '&layout=edit'); ?>" method="post" name="adminForm" id="item-form" class="form-validate form-inline">
    <fieldset>
    ...
    <?php echo JHtml::_('tabs.start', 'topicform', array('useCookie' => 'true')) ;?>
    <?php echo JHtml::_('tabs.panel', JText::_('COM_PROJECTFORK_FIELDSET_PUBLISHING'), 'topic-publishing') ;?>
    <fieldset>
        <div class="formelm control-group">
            <div class="control-label">
    ...
    <?php if (PFApplicationHelper::enabled('com_pfforum')) : ?>
        <?php echo JHtml::_('tabs.panel', JText::_('COM_PROJECTFORK_FIELDSET_ATTACHMENTS'), 'topic-attachments') ;?>
        <fieldset>
        	<div class="formelm control-group">
    ...
    if (count($fieldsets)) :
        echo JHtml::_('tabs.panel', JText::_('COM_PROJECTFORK_DETAILS_FIELDSET'), 'topic-options');
