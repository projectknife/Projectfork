...
<div id="projectfork" class="category-list<?php echo $this->pageclass_sfx;?> view-projects">
    ...
    <div class="cat-items">
        ...
        <form name="adminForm" id="adminForm" action="<?php echo JRoute::_(PFprojectsHelperRoute::getProjectsRoute() . '&layout=modal&tmpl=component&function=' . $function);?>" method="post">
